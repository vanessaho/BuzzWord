 ...
 */
public abstract class WordApp extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        try {
            ...
            System.out.println("WORDAPP ERROR");
    ...
    public boolean loadProperties(InitializationParameters propertyParameter) {
        try {
            propertyManager.loadProperties(WordApp.class, propertyParameter.getParameter(), PROPERTIES_SCHEMA_XSD.getParameter());
